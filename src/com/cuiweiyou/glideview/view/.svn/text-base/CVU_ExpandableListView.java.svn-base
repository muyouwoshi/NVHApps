 ...
 * 可侧滑的 可展开ListView
 */
public class CVU_ExpandableListView extends ExpandableListView {
	...
	public CVU_ExpandableListView(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		initData(context);
	}

	public CVU_ExpandableListView(Context context, AttributeSet attrs) {
		super(context, attrs);
		initData(context);
	}

	public CVU_ExpandableListView(Context context) {
		super(context);
		initData(context);
	}
